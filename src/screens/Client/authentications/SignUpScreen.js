...
} from "../../../store/Client/actions/Client_SignUp_actions";
  ...
  return (
    <KeyboardAwareScrollView>
      <View>
        ...
        <SuccessModal
          modalVisible={requestState.success}
          closeModal={() => {
            disptach(ClearSignUpStateAction()), navigation.navigate("SignIn");
          }}
        ...
        <ErrorModal
          ...
          closeModal={() => {
            disptach(ClearSignUpStateAction());
          }}
        ...
        >
          ...
          <Text style={signUpStyle.ByClickingText}>
            By clicking continue you are agreeing to our{" "}
          </Text>
          <View>
            <TouchableOpacity>
              <Text style={signUpStyle.terms_conditionsbutton}>
